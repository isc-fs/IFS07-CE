...
uint8_t
TM_DS18B20_Start(TM_OneWire_t* OneWire, uint8_t* ROM) {
...
uint8_t
TM_DS18B20_GetResolution(TM_OneWire_t* OneWire, uint8_t* ROM) {
    uint8_t conf;
...
uint8_t
TM_DS18B20_SetAlarmLowTemperature(TM_OneWire_t* OneWire, uint8_t* ROM, int8_t temp) {
    uint8_t tl, th, conf;
    if (!TM_DS18B20_Is(ROM)) {
        return 0;
    }
...
uint8_t
TM_DS18B20_SetAlarmHighTemperature(TM_OneWire_t* OneWire, uint8_t* ROM, int8_t temp) {
    uint8_t tl, th, conf;
    if (!TM_DS18B20_Is(ROM)) {
        return 0;
    }
...
uint8_t
TM_DS18B20_DisableAlarmTemperature(TM_OneWire_t* OneWire, uint8_t* ROM) {
    uint8_t tl, th, conf;
    if (!TM_DS18B20_Is(ROM)) {
        return 0;
    }
...
uint8_t
TM_DS18B20_AlarmSearch(TM_OneWire_t* OneWire) {
    /* Start alarm search */
