...
//#define void Delay_us(uint16_t us);
/* OneWire delay */
...
#define ONEWIRE_INPUT(structure)        Set_DQ_Pin_Input(structure->GPIOx, (structure)->GPIO_Pin)
#define ONEWIRE_OUTPUT(structure)       Set_DQ_Pin_Output(structure->GPIOx, (structure)->GPIO_Pin)
