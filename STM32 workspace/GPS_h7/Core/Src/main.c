...
char uart_msg[100];
char uart_gps[100];
uint8_t pulsador_ant = 1, pulsador_act = 1;
/* USER CODE END PV */
...
int main(void)
{
  ...
  print(". . . . . .");
  static const struct GPGGA_Data EmptyGPGGAStruct;
  GPGGA_Data data;
  ...
  while (1)
  {
	...
	//MX_GPIO_Init();
	//MX_USART2_UART_Init();
	// Por algún motivo hace falta que este init esté en el bucle
	MX_USART1_UART_Init();
